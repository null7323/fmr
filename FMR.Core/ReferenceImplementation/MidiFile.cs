...
namespace FMR.Core.ReferenceImplementation
{
    /// <summary>
    /// 表示参考实现所用的音符类型.
    /// </summary>
    ...
    public struct Note : IUnmanagedComparable<Note>
    {
        ...
        /// 判定指定键盘号是否对应黑键.
        /// </summary>
        /// <param name="key">键号.</param>
        /// <returns>一个<see langword="bool"/>值, 指定当亲键号对应的是否为黑键.</returns>
        ...
        /// <returns>一个<see langword="bool"/>值, 指示左比较音符是否应该位于右比较音符前.</returns>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
    ...
    /// 拍号事件.
    /// </summary>
    /// <param name="tick">节拍事件的时刻.</param>
    /// <param name="numerator">每小节拍数.</param>
    /// <param name="denominator">每拍的时值.</param>
    [StructLayout(LayoutKind.Sequential)]
    ...
    public unsafe class MidiFile : IMidiLoader, IDisposable
    {
        ...
        /// <summary>
        /// 内部状态. 判定当亲 Midi 文件是否已完成加载.
        /// </summary>
        protected bool parsed = false;
        /// <summary>
        /// 内部状态, 给出当前 Midi 的总时长 (单位微秒).
        /// </summary>
