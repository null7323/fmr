...
namespace SDL3
{
    public static unsafe partial class SDL
    {
        ...
        private const string nativeLibName = "Dependencies\\SDL3.dll";
        ...
        [LibraryImport(nativeLibName)]
        [UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
        public static partial SDLBool SDL_SetSurfaceBlendMode(SDL.SDL_Surface* surface, uint blendMode);
        ...
        [LibraryImport(nativeLibName)]
        [UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
        public static partial SDLBool SDL_FillSurfaceRect(SDL_Surface* dst, SDL_Rect* rect, uint color); // WARN_UNKNOWN_POINTER_PARAMETER
        ...
        [LibraryImport(nativeLibName)]
        [UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
        public static partial SDLBool SDL_BlitSurfaceScaled(SDL_Surface* src, SDL_Rect* srcrect, SDL_Surface* dst, SDL_Rect* dstrect, SDL_ScaleMode scaleMode); // WARN_UNKNOWN_POINTER_PARAMETER

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SDLBool SDL_BlitSurfaceScaled(SDL_Surface* src, ref SDL_Rect srcrect, SDL_Surface* dst, ref SDL_Rect dstrect, SDL_ScaleMode scaleMode)
        {
            fixed (SDL_Rect* pSrc = &srcrect, pDst = &dstrect)
            {
                return SDL_BlitSurfaceScaled(src, pSrc, dst, pDst, scaleMode);
            }
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SDLBool SDL_BlitSurfaceScaled(SDL_Surface* src, SDL_Rect* srcrect, SDL_Surface* dst, ref SDL_Rect dstrect, SDL_ScaleMode scaleMode)
        {
            fixed (SDL_Rect* pDst = &dstrect)
            {
                return SDL_BlitSurfaceScaled(src, srcrect, dst, pDst, scaleMode);
            }
        }
        ...
        [LibraryImport(nativeLibName)]
        [UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
        public static partial SDLBool SDL_BlitSurfaceUncheckedScaled(SDL_Surface* src, SDL_Rect* srcrect, SDL_Surface* dst, SDL_Rect* dstrect, SDL_ScaleMode scaleMode); // WARN_UNKNOWN_POINTER_PARAMETER

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SDLBool SDL_BlitSurfaceUncheckedScaled(SDL_Surface* src, ref SDL_Rect srcrect, SDL_Surface* dst, ref SDL_Rect dstrect, SDL_ScaleMode scaleMode)
        {
            fixed (SDL_Rect* pSrc = &srcrect, pDst = &dstrect)
            {
                return SDL_BlitSurfaceUncheckedScaled(src, pSrc, dst, pDst, scaleMode);
            }
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SDLBool SDL_BlitSurfaceUncheckedScaled(SDL_Surface* src, SDL_Rect* srcrect, SDL_Surface* dst, ref SDL_Rect dstrect, SDL_ScaleMode scaleMode)
        {
            fixed (SDL_Rect* pDst = &dstrect)
            {
                return SDL_BlitSurfaceUncheckedScaled(src, srcrect, dst, pDst, scaleMode);
            }
        }
        ...
        [LibraryImport(nativeLibName)]
        [UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
        public static partial SDL_Texture* SDL_CreateTextureFromSurface(IntPtr renderer, SDL.SDL_Surface* surface);
        ...
        [LibraryImport(nativeLibName)]
        [UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
        public static partial SDLBool SDL_SetTextureAlphaMod(SDL_Texture* texture, byte alpha); // WARN_UNKNOWN_POINTER_PARAMETER

        [LibraryImport(nativeLibName)]
        [UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
        public static partial SDLBool SDL_SetTextureAlphaModFloat(SDL_Texture* texture, float alpha); // WARN_UNKNOWN_POINTER_PARAMETER

        [LibraryImport(nativeLibName)]
        [UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
        public static partial SDLBool SDL_GetTextureAlphaMod(SDL_Texture* texture, out byte alpha); // WARN_UNKNOWN_POINTER_PARAMETER

        [LibraryImport(nativeLibName)]
        [UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
        public static partial SDLBool SDL_GetTextureAlphaModFloat(SDL_Texture* texture, out float alpha); // WARN_UNKNOWN_POINTER_PARAMETER

        [LibraryImport(nativeLibName)]
        [UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
        public static partial SDLBool SDL_SetTextureBlendMode(SDL_Texture* texture, uint blendMode); // WARN_UNKNOWN_POINTER_PARAMETER

        [LibraryImport(nativeLibName)]
        [UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
        public static partial SDLBool SDL_GetTextureBlendMode(SDL_Texture* texture, IntPtr blendMode); // WARN_UNKNOWN_POINTER_PARAMETER

        [LibraryImport(nativeLibName)]
        [UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
        public static partial SDLBool SDL_SetTextureScaleMode(SDL_Texture* texture, SDL_ScaleMode scaleMode); // WARN_UNKNOWN_POINTER_PARAMETER

        [LibraryImport(nativeLibName)]
        [UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
        public static partial SDLBool SDL_GetTextureScaleMode(SDL_Texture* texture, out SDL_ScaleMode scaleMode); // WARN_UNKNOWN_POINTER_PARAMETER

        [LibraryImport(nativeLibName)]
        [UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
        public static partial SDLBool SDL_UpdateTexture(SDL_Texture* texture, SDL_Rect* rect, IntPtr pixels, int pitch); // WARN_UNKNOWN_POINTER_PARAMETER

        [LibraryImport(nativeLibName)]
        [UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
        public static partial SDLBool SDL_UpdateYUVTexture(SDL_Texture* texture, ref SDL_Rect rect, IntPtr Yplane, int Ypitch, IntPtr Uplane, int Upitch, IntPtr Vplane, int Vpitch); // WARN_UNKNOWN_POINTER_PARAMETER

        [LibraryImport(nativeLibName)]
        [UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
        public static partial SDLBool SDL_UpdateNVTexture(SDL_Texture* texture, ref SDL_Rect rect, IntPtr Yplane, int Ypitch, IntPtr UVplane, int UVpitch); // WARN_UNKNOWN_POINTER_PARAMETER

        [LibraryImport(nativeLibName)]
        [UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
        public static partial SDLBool SDL_LockTexture(SDL_Texture* texture, ref SDL_Rect rect, out IntPtr pixels, out int pitch); // WARN_UNKNOWN_POINTER_PARAMETER

        [LibraryImport(nativeLibName)]
        [UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
        public static partial SDLBool SDL_LockTextureToSurface(SDL_Texture* texture, ref SDL_Rect rect, out IntPtr surface); // WARN_UNKNOWN_POINTER_PARAMETER

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        [LibraryImport(nativeLibName)]
        [UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
        public static partial void SDL_UnlockTexture(SDL_Texture* texture); // WARN_UNKNOWN_POINTER_PARAMETER

        [LibraryImport(nativeLibName)]
        [UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
        public static partial SDLBool SDL_SetRenderTarget(IntPtr renderer, SDL_Texture* texture); // WARN_UNKNOWN_POINTER_PARAMETER
        ...
        [LibraryImport(nativeLibName)]
        [UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
        public static partial SDLBool SDL_RenderFillRect(IntPtr renderer, SDL_FRect* rect);

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SDLBool SDL_RenderFillRect(IntPtr renderer, ref SDL_FRect rect)
        {
            fixed (SDL_FRect* pRect = &rect)
            {
                return SDL_RenderFillRect(renderer, pRect);
            }
        }
        ...
        [LibraryImport(nativeLibName)]
        [UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
        public static partial SDLBool SDL_RenderTexture(IntPtr renderer, SDL_Texture* texture, SDL_FRect* srcrect, SDL_FRect* dstrect); // WARN_UNKNOWN_POINTER_PARAMETER
        
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SDLBool SDL_RenderTexture(IntPtr renderer, SDL_Texture* texture, SDL_FRect* srcrect, ref SDL_FRect dstrect)
        {
            fixed (SDL_FRect* pRect = &dstrect)
            {
                return SDL_RenderTexture(renderer, texture, srcrect, pRect);
            }
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SDLBool SDL_RenderTexture(IntPtr renderer, SDL_Texture* texture, ref SDL_FRect srcrect, ref SDL_FRect dstrect)
        {
            fixed (SDL_FRect* pSrc = &srcrect, pDst = &dstrect)
            {
        ...
        [LibraryImport(nativeLibName)]
        [UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
        public static partial SDLBool SDL_RenderTextureRotated(IntPtr renderer, SDL_Texture* texture, SDL_FRect* srcrect, SDL_FRect* dstrect, double angle, SDL_FPoint* center, SDL_FlipMode flip); // WARN_UNKNOWN_POINTER_PARAMETER

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SDLBool SDL_RenderTextureRotated(IntPtr renderer, SDL_Texture* texture, SDL_FRect* srcrect, ref SDL_FRect dstrect, double angle, SDL_FPoint* center, SDL_FlipMode flip)
        {
            fixed (SDL.SDL_FRect* pDst = &dstrect)
            {
                return SDL_RenderTextureRotated(renderer, texture, srcrect, pDst, angle, center, flip);
            }
        }

        [LibraryImport(nativeLibName)]
        [UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
        public static partial SDLBool SDL_RenderTextureAffine(IntPtr renderer, SDL_Texture* texture, SDL_FRect* srcrect, SDL_FPoint origin, SDL_FPoint* right, SDL_FPoint* down);

        [LibraryImport(nativeLibName)]
        [UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
        public static partial SDLBool SDL_RenderTextureTiled(IntPtr renderer, SDL_Texture* texture, SDL_FRect* srcrect, float scale, SDL_FRect* dstrect); // WARN_UNKNOWN_POINTER_PARAMETER

        [LibraryImport(nativeLibName)]
        [UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
        public static partial SDLBool SDL_RenderTexture9Grid(IntPtr renderer, SDL_Texture* texture, SDL_FRect* srcrect, float left_width, float right_width, float top_height, float bottom_height, float scale, SDL_FRect* dstrect); // WARN_UNKNOWN_POINTER_PARAMETER

        [LibraryImport(nativeLibName)]
        [UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
        public static partial SDLBool SDL_RenderGeometry(IntPtr renderer, SDL_Texture* texture, SDL_Vertex* vertices, int num_vertices, int* indices, int num_indices); // WARN_UNKNOWN_POINTER_PARAMETER

        [LibraryImport(nativeLibName)]
        [UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
        public static partial SDLBool SDL_RenderGeometryRaw(IntPtr renderer, SDL_Texture* texture, IntPtr xy, int xy_stride, IntPtr color, int color_stride, IntPtr uv, int uv_stride, int num_vertices, IntPtr indices, int num_indices, int size_indices); // WARN_UNKNOWN_POINTER_PARAMETER

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static SDL_Surface* SDL_RenderReadPixels(IntPtr renderer, ref SDL_Rect rect)
        {
            fixed (SDL_Rect* pRect = &rect)
            {
                return SDL_RenderReadPixels(renderer, pRect);
            }
        }
        ...
        [LibraryImport(nativeLibName)]
        [UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
        public static partial SDL_Surface* SDL_RenderReadPixels(IntPtr renderer, SDL_Rect* rect);
        ...
        [LibraryImport(nativeLibName)]
        [UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
        public static partial void SDL_DestroyTexture(SDL_Texture* texture); // WARN_UNKNOWN_POINTER_PARAMETER
        ...
        [LibraryImport(nativeLibName)]
        [UnmanagedCallConv(CallConvs = [typeof(CallConvCdecl)])]
        public static partial int SDL_RunApp(int argc, IntPtr argv, SDLMainFunc mainFunction, IntPtr reserved);
